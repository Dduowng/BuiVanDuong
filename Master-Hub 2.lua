...
ImageButton.Image = "rbxassetid://16339522924"
...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("Thông Báo" , "Link Facebook Ở Cài Đặt" , 6 ,11816162894 )
...
Setting:Button("Sao Chép Link",function()
 
 setclipboard("https://m.facebook.com/profile.php?id=100073197451029&mibextid=2JQ9oc&wtsid=rdr_0TVPCTqNhQAUm4xja")
...
for k,v in pairs(ListHuhu) do
    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..k,true) == 1 then 
        ...
        if type(v)=="string" then 
            ...
            huhu.Image = "rbxassetid://16339522924"
